...
tags:
  - .NET
summary: Adding Claims transformations (aka claims augmentation) to a MVC claims based application doesn't take a lot of code, but knowing where to put it isn't obvious.
---
