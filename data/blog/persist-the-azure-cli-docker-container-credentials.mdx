...
tags:
  - Azure
  - Docker
summary: Docker for the Azure-Cli makes updating simpler. I show how you can stop the need to login every time by saving your credentials.
---
...
![Azure-cli files created in /root/.azure](/static/images/2019/04/files_created_in_root_azure.png 'Azure-cli files created in /root/.azure')
